...
const viewAllDepartments = connection.query(`SELECT * FROM employee_tracker.department`, (err, results) => {
    err ? console.log(err) : console.table(results)
});

// View All Roles
const viewAllRoles = connection.query(`
...
// View All Employees
const viewAllEmployees = connection.query(`
